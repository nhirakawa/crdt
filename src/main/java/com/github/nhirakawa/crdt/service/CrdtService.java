...
public class CrdtService extends Application<CrdtConfiguration> {
  ...
  public void initialize(Bootstrap<CrdtConfiguration> bootstrap) {
    GuiceBundle<CrdtConfiguration> guiceBundle = GuiceBundle.<CrdtConfiguration>newBuilder()
  ...
  @Override
  public void run(CrdtConfiguration configuration, Environment environment) throws Exception {
    Preconditions.checkArgument(!Strings.isNullOrEmpty(configuration.getNodeId()), "must set nodeId in crdt.yaml");
  }
